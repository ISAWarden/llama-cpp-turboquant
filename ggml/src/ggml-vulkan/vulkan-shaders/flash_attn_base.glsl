...
// Turbo cache types need byte strides because their std430 blocks are not power-of-two sized.
#if defined(DATA_A_TURBO2_0) && !defined(BLOCK_BYTE_SIZE)
#define BLOCK_BYTE_SIZE 34 // block_turbo2_0: 2 (norm) + 32 (qs)
#elif defined(DATA_A_TURBO3_0) && !defined(BLOCK_BYTE_SIZE)
#define BLOCK_BYTE_SIZE 50 // block_turbo3_0: 2 (norm) + 32 (qs) + 16 (signs)
#elif defined(DATA_A_TURBO4_0) && !defined(BLOCK_BYTE_SIZE)
#define BLOCK_BYTE_SIZE 68 // block_turbo4_0: 2 (norm) + 2 (rnorm) + 64 (qs)
#endif
