...
> [!IMPORTANT]
> This fork is intended for creativity, experimentation, and research.
> AI-assisted development is welcome, including AI-generated code, tests,
> benchmark scripts, documentation, and exploratory prototypes.
>
> The upstream llama.cpp AI contribution policy does not apply to work that
> stays inside this fork. See [AGENTS.md](AGENTS.md) for the agent-facing
> version of this policy.

AI tools may be used broadly in this repository. Contributors may use AI to
implement experiments, generate or refactor code, write tests, draft
documentation, analyze performance, and explore unfamiliar parts of the
codebase. AI-generated work does not require special disclosure for local fork
work unless the contributor wants to record that context.

Contributors are still expected to keep changes reviewable and reproducible:
...
5. Clearly mark experimental code when behavior, accuracy, performance, or API stability is uncertain.

If a change is intended for submission to upstream llama.cpp, follow the
upstream project's contribution and AI policies before preparing that
submission.
...
- The contributor fails to adhere to this contributing guide or misrepresents whether a change is intended for local fork use or upstream submission.
